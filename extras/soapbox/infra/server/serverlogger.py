...
class ServerLogger:
    ...
    def __init__(self, name='derbyserver', log_file='/var/log/derbynet.log', level=logging.INFO):
        ...
        # Syslog handler
        formatter = logging.Formatter(fmt=DERBY_SYSLOG_FORMAT.format(name))
...
if __name__ == "__main__":
    # Example usage
    #logger = ServerLogger(name='derby', log_file='/var/log/derbynet.log', level=logging.INFO).get_logger()
    logger = ServerLogger(level=logging.DEBUG).get_logger()
