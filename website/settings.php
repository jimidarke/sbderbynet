...
<body>
    ...
    // As of 24-03-2025
    $weightUnits = read_raceinfo('weight-units');
    ...
    <div class="block_buttons">
        <form id="settings_form">
                ...
                <div class="settings_group_settings">
                    ...
                    <div class="track-settings">
                        ...
                        <p>
                            ...
                            Lanes available for scheduling:
                        </p>
                        <p>
            ...
            <div class="settings_group">
                ...
                <div class="settings_group_settings">
                    <p>
                        <input class="not-mobile use-weight-units" id="weight-kgs" name="weight-units" type="radio" value="kg" <?= ($weightUnits == "kg") ? 'checked' : '' ?> />
                        <label for="weight-kgs">Display Car/Cart Weight in Kilograms (kgs)</label>
                    </p>
                    <p>
                        <input class="not-mobile use-weight-units" id="weight-lbs" name="weight-units" type="radio" value="lbs" <?= ($weightUnits == "lbs") ? 'checked' : '' ?> />
            ...
            <div class="settings_group">
                <div class="settings_group_image">
                    <img src="img/derby-heat-ordering.png" style="width: 100%;" />
                </div>
                <div class="settings_group_settings">
                    <p><strong>Heat Ordering Options</strong></p>
                    <p>Selecting "Medium" weight for each criterion produces excellent heat sequence. Chart generation times increase when ordering options are used.</p>

                    <div class="d-flex">
                        <label for="heat-counts">Keep heat counts even?</label>
                    ...
                    <div class="d-flex">
                        <label for="avoid-same-lane">Avoid cars in the same lanes in consecutive races?</label>
                        <div class="weight-container">
                            <label for="weight-label">Weight</label>
