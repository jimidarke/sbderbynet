...
// database dialog.
  ...
  <div id="schema_step" class="step_div">
    ...
    <div class="lower">
      <div class="step_button block_buttons">
        <input id="purge_data_button" type="button" value="Purge Data" onclick="show_purge_modal()" />
      </div>
  ...
  <div id="ezsetup_modal" class="modal_dialog hidden block_buttons">
    <form>
      ...
      <input type="button" value="Cancel" onclick="close_modal('#ezsetup_modal');" />
      <br />
      <input type="button" value="Advanced" onclick="show_advanced_database_modal()" />
    </form>
  </div>
  ...
  <div id="advanced_database_modal" class="modal_dialog wide_modal tall_modal hidden block_buttons">
    <form>
      ...
      <div id="for_sqlite_connection" class="hidden connection_details">
        <input type="button" id="browse_for_sqlite" value="Browse" onclick='show_choose_file_modal($("#sqlite_path").val(), "new.sqlite",
                                       function(fullpath) {
      ...
      <div id="for_string_connection">
        ...
        <input type="text" name="connection_string" id="connection_string" <?php
      ...
      <input type="submit" value="Submit" />
      <input type="button" value="Cancel" onclick='close_modal("#advanced_database_modal");' />
    </form>
  </div>
  ...
  <div id="initialize_schema_modal" class="modal_dialog hidden block_buttons">
    <form>
      ...
      <input type="button" value="Cancel" onclick='close_secondary_modal("#initialize_schema_modal");' />
    </form>
  </div>
  ...
  <div id="update_schema_modal" class="modal_dialog hidden block_buttons">
    <form>
      ...
      <input type="button" value="Cancel" onclick='close_modal("#update_schema_modal");' />
    </form>
  </div>
  ...
  <div id="purge_modal" class="modal_dialog wide_modal block_buttons hidden">
    <form>
      <div id="purge_modal_inner">
        ...
        <div class="purge_div">
          <div class="purge_button block_buttons">
            <input type="button" id="delete_schedules" value="Delete Schedules" onclick="confirm_purge('schedules');" />
          </div>
        ...
        <div class="purge_div">
          <div class="purge_button block_buttons">
            <input type="button" id="delete_racers" value="Delete Racers" onclick="confirm_purge('racers');" />
          </div>
        ...
        <div class="purge_div">
          <div class="purge_button block_buttons">
            <input type="button" id="delete_awards" value="Delete Awards" onclick="confirm_purge('awards');" />
          </div>
        ...
        <div class="purge_div">
          <div class="purge_button block_buttons">
            <input type="button" value="Re-Initialize" onclick="show_initialize_schema_modal();" />
          </div>
  ...
  <div id="purge_confirmation_modal" class="modal_dialog hidden block_buttons">
    <form>
  ...
  <div id="reporting_box" class="hidden">
    ...
    <div id="reporting_box_dismiss" class="hidden" onclick="hide_reporting_box(); return false;">Dismiss</div>
  </div>
